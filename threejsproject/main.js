...
function onSelectStartVR(event) {
  ...
  for (let i = 0; i < intersects.length; i++) {
    ...
    if (object.isImage) {
      ...
      if (paintingInfo) {
        innerTextWindow(paintingInfo.title);
      }
      break;
    }
  }
...
// Interaktive Texte für UI anzeigen
  ...
  uiContext.fillText(text,50,100);
